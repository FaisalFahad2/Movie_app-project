...
class _TopRatedPageState extends State<TopRatedPage> {
  ...
  void initState() {
    ...
    _futureMovies = movieApi.getTopRatedMovies().then((movies) async {
      allMovies = movies;
  ...
  Future<void> _refreshRatings() async {
    ...
    try {
      final freshMovies = await movieApi.getTopRatedMovies();
  ...
  // ─────────────────────────────────────────────
  Future<void> _loadActorsInBackground(
      MovieApi api, List<MovieModel> movies) async {
    for (final movie in movies) {
